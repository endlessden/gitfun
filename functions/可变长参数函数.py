...
# anyargs(12,213,123,[34,23],x='momo',y='bobo')    #位置参数接收为元祖，关键字参数接收为字典



# def test(y=[1,2,3]):              #函数默认参数必须为不可变类型，否则默认参数就会发生变化
# 	y.append('last')
# 	print(y)
...
# def add(x:'int',y:'int'):   #函数参数注解 ，提示如何正确传参 ,一般使用类或字符串
# 	print(x+y)
...
# print(add.__annotations__)  #注解的名称空间
...
# func(213,324,123,key=99,keys=199)
...
print('what\'s i can do with python')
