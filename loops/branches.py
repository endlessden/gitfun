...
if requested_toppings:
	for x in range(5):
		requested_toppings.append(x)
else:
	print('you need a plain pizza?')
...
usernames = ['adomin','admin','molly','lisa','Alvin']
